...
if(isset($_SESSION['error_msg']) && count($_SESSION['error_msg'])>0){
  ...
  $mode = $_SESSION['mode'];
  //消去
  clear_session(['error_msg','price','persons','mode']);
}
?>
<!doctype html>
<html lang="ja">
  ...
  <body>
    ...
    <form action="result.php" method="post">
      ...
      <div>
        <input type="radio" name="mode" id="mode_yeb1" value="1" <?php if($mode == 1) echo "checked" ?>>
        <label for="mode_yeb1">1円単位</label>
        <input type="radio" name="mode" id="mode_yeb10" value="10" <?php if($mode == 10) echo "checked" ?>>
        <label for="mode_yeb10">10円単位</label>
      </div>
