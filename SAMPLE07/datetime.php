...
<html lang="ja">
  <head>
    ...
    <title>DateTimeオブジェクト</title>
  </head>
  <body>
      <div class="container">
        <h1>DateTimeオブジェクト</h1>
        <ul class="list-group">
            <li class="list-group-item">現在の日時:<?=$current_datetime?></li>
            <li class="list-group-item">指定された日時:<?=$assignment_datetime?></li>
        </ul>
      </div>
